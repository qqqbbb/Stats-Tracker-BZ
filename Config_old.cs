...
namespace Stats_Tracker
{
    ...
    {
        //public enum qqq { ST_void, second };

        //[Choice("ST_thermal_spires")]
        //public qqq www;
        [Toggle("ST_mod_enabled", Tooltip = "")]
        ...
        internal bool bornCreaturesFixed;
        internal bool squidSharkKillsFixed;
    }
}